        ...
        if passwordTextField.text != confirmPasswordTextField.text {
            ...
            Auth.auth().createUser(withEmail: emailTextField.text!, password: passwordTextField.text!) { (user, error) in
                ...
                if user != nil {
                    ...
                    let values = ["name": name, "email": email, "studentName": kidName, "address": addressFull, "accountBalance": accountBalance, "phone": phone, "driverStatus": driverStatus, "carMake": carMake, "carModel": carModel, "carColor": carColor, "carYear": carYear, "carPlate": carLicencePlate, "homeLat": homeLat, "homeLong": homeLong] as [String : Any]
